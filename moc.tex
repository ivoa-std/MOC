...
to 1 - i.\,e. represented as a negative integer (twos complement negative).
The order of dimensions is always time first.
...
\par\noindent
This list of ranges will be  coded in in a list of 64bits signed integers as:
\begin{verbatim}
   -tmin1 -tmax2 smin1 smax1 -tmin2 -tmax2 smin2 smax2 smin3 smax3
\end{verbatim}
